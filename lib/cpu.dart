...
enum CpuAlgo { FCFS, SJF, RR, Random }
...
String getCpuData(DataChoice valik) {
  switch (valik) {
    case DataChoice.First:
      return "0,3;6,9;6,5;15,10";
    case DataChoice.Second:
      return "0,3;0,5;12,4;15,5;21,16";
    case DataChoice.Third:
      return "3,7;6,9;11,3;16,9";
    default:
      return "";
  }
}

Widget runCpuAlgo(CpuAlgo algo, StringBuffer log, List<List<num>> processes,int RR_WINDOW) {
  switch (algo) {
    case CpuAlgo.FCFS:
